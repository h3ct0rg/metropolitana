...
namespace Metropolitan.Controllers
{
    ...
    {
        OperacionPagoTravelManagement gestordb = new OperacionPagoTravelManagement();
        ...
        [HttpGet("GetOrdenesPendientesGroupedBySucursal")]
        public ActionResult<IEnumerable<listaOrdenDePagoTravelace>> GetOrdenesPendientesGrouped(int sucursal)
        {
            List<listaOrdenDePagoTravelace> notaDebito = new List<listaOrdenDePagoTravelace>();
            notaDebito = gestordb.getListOrdenesPendientesGroup(sucursal);
            string json = JsonConvert.SerializeObject(notaDebito);
            return notaDebito;
        }
        ...
        public ActionResult<operacionPagoTravelace> GetOrdenByCliendId(string idNota, string idsucursal)
        {
            operacionPagoTravelace notaDebito = new operacionPagoTravelace();
