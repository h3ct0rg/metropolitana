...
namespace Metropolitan.Controllers.carga
{
    ...
    [ApiController]
    public class NotaDebitoCargaController : ControllerBase
    {
        cargaNotaDebitoTravelManagement gestordb = new cargaNotaDebitoTravelManagement();
        ...
        {
            string result = gestordb.deleteCargaNotaDebito(idNota, idUser);
