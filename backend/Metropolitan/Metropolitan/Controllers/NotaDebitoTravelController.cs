...
namespace Metropolitan.Controllers
{
    ...
    [ApiController]
    public class NotaDebitoTravelController : ControllerBase
    {
        NotaDebitoTravelManagement gestordb = new NotaDebitoTravelManagement();
        ...
        [HttpGet("GetBySucursalComplete")]
        public ActionResult<IEnumerable<notaDebitoTravelace>> GetBySucursalComplete(int id)
        {
            List<notaDebitoTravelace> notaDebito = new List<notaDebitoTravelace>();
            notaDebito = gestordb.getListNotaDebitoCompleteBySucursal(id);
            string json = JsonConvert.SerializeObject(notaDebito);
            return notaDebito;
        }
        ...
        [HttpGet("getNotaDebitoEstado")]
        public ActionResult<int> getNotaDebitoEstado(int id, int idSucursal)
        {
            int notaDebito = 0;
            notaDebito = gestordb.getNotaDebitoEstado(id, idSucursal);
            string json = JsonConvert.SerializeObject(notaDebito);
            return notaDebito;
        }
        ...
        {
            string result = gestordb.deleteTravelAceNotaDebito(idNota, idUser);
