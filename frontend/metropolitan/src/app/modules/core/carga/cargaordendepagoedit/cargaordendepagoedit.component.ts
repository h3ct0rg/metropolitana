...
@Component({
  selector: 'app-cargaordendepagoedit',
  templateUrl: './cargaordendepagoedit.component.html',
  styleUrls: ['./cargaordendepagoedit.component.css']
})
export class CargaordendepagoeditComponent implements OnInit {
  ...
  constructor(
    ...
    private ordenPagoListService: CargaOrdenPagoService
  ) {
