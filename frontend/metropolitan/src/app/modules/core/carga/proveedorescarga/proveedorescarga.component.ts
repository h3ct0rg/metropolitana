...
@Component({
  selector: 'app-proveedorescarga',
  templateUrl: './proveedorescarga.component.html',
  styleUrls: ['./proveedorescarga.component.css']
})
export class ProveedorescargaComponent implements OnInit {
  ...
  loadFarmInformation(clienteId) {
    this.operadorService.getOperadorCarga(clienteId).subscribe((result) => {
  ...
  saveOperador() {
    ...
    if (this.isEdit) {
      ...
      this.operadorService.updateOperadorCarga(this.operador).subscribe((data) => {
        this.router.navigate(['/main/carga/proveedorList']);
      });
    }
    else {
      this.operadorService.saveOperadorItemCarga(this.operador).subscribe((data) => {
        this.router.navigate(['/main/carga/proveedorList']);
      });
    }
  }
