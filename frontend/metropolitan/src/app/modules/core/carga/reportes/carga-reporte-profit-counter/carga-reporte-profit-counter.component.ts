...
@Component({
  ...
  templateUrl: './carga-reporte-profit-counter.component.html',
  styleUrls: ['./carga-reporte-profit-counter.component.css']
})
export class CargaReporteProfitCounterComponent implements OnInit {
  ...
  generateNote() {
    ...
    this.totalCounter = 0;
    this.totalSumar = 0;
    this.counterService.getCounterProfitByDateCargaDetalle(this.form.get("fechaStardDate").value, this.form.get("fechaEndDate").value).subscribe(result => {
