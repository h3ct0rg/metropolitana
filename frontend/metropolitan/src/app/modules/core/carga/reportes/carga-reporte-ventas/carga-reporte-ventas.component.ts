...
@Component({
  ...
  templateUrl: './carga-reporte-ventas.component.html',
  styleUrls: ['./carga-reporte-ventas.component.css']
})
export class CargaReporteVentasComponent implements OnInit {
  ...
  constructor(
    ...
    counterService.getCounterListCarga().subscribe(result => {
