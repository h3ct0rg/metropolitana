...
@Component({
  selector: 'app-clientespaquetes',
  templateUrl: './clientespaquetes.component.html',
  styleUrls: ['./clientespaquetes.component.css']
})
export class ClientespaquetesComponent implements OnInit {
  ...
  loadFarmInformation(clienteId) {
    this.clienteService.getClientPaquetes(clienteId).subscribe((result) => {
  ...
  saveClient() {
    ...
    if (this.isEdit) {
      ...
      this.clienteService.updatePaqueteCliente(this.cliente).subscribe((data) => {
        this.router.navigate(['/main/paquetes/clientesList']);
      });
    }
    else {
      this.clienteService.saveClientPaqueteItem(this.cliente).subscribe((data) => {
        this.router.navigate(['/main/paquetes/clientesList']);
      });
    }
  }
