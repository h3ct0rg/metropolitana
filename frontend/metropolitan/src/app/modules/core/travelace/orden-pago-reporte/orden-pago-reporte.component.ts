...
@Component({
  selector: 'app-orden-pago-reporte',
  templateUrl: './orden-pago-reporte.component.html',
  styleUrls: ['./orden-pago-reporte.component.css']
})
export class OrdenPagoReporteComponent implements OnInit {
  form: FormGroup;
  disabled = true;
  pagados = false;
  listOfData = [];
  ...
  constructor(
    private listReportOrdenPago: ListaOrdenPagoReportService,
