...
@Injectable()
export class ListaOrdenPagoReportService extends BaseService<OrdenPagoReport> {
  ...
  getOrdenPagoListReport = (itemFilter, sucursal, itemCodOden?): Observable<any> => {
    let data = this.post('/OrdenPago/GetListOrdenPagoReport', { filter: itemFilter, codOrden: itemCodOden, idSucursal: sucursal });
    return data;
  }
}
