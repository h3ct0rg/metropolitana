...
@Injectable()
export class PaqueteNotaDebitoCalculateService extends BaseService<NotaDebitoCalculate> {
  ...
  getNotaDebitoCalculate(notacalculate: NotaDebitoCalculate) {
    return this.post('/NotaDebitoPaquetes/CalcularNotaDebito', notacalculate) as Observable<NotaDebitoCalculate>;
  }
