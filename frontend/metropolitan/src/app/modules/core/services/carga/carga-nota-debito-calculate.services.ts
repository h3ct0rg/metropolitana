...
@Injectable()
export class CargaNotaDebitoCalculateService extends BaseService<NotaDebitoCalculate> {
  ...
  getNotaDebitoCalculate(notacalculate: NotaDebitoCalculate) {
    return this.post('/NotaDebitoCarga/CalcularNotaDebito', notacalculate) as Observable<NotaDebitoCalculate>;
  }
