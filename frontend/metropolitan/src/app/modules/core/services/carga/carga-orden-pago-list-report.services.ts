...
@Injectable()
export class CargaListaOrdenPagoReportService extends BaseService<OrdenPagoReport> {
  ...
  getOrdenPagoListReport = (itemFilter, sucursal,itemCodOden?): Observable<any> => {
    let data = this.post('/CargaOrdenPago/GetListOrdenPagoReport', { filter: itemFilter, codOrden: itemCodOden, idSucursal: sucursal });
    return data;
  }
}
