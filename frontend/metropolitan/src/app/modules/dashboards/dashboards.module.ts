...
@NgModule({
    declarations: [MainDashboardComponent, KpiCardComponent, FinancialDashboardComponent, ActivityDashboardComponent],
    imports: [
    ...
    providers: [DashboardFinancialService, DashboardActivityService, ThemeService],
